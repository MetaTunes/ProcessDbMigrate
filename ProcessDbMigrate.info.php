...
$info = array(
	...
	'author' => 'Mark Evens',
	'version' => "2.0.1", // Versions >= 0.1.0 use FieldtypeDbMigrateRuntime not RuntimeOnly. Versions >= 1.0.0 have change tracking (scope at individual migration level for v2.0.0+).
	'autoload' => true,
	'singular' => true,
